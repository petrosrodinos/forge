...
export function buildToolDefs(): Tool[] {
  return [
    ...
    { type: "function", function: { name: "tripo_createTask", description: "Create Tripo V3 task (pass V2-style type; client routes to the matching V3 endpoint)", parameters: { type: "object", properties: {}, required: ["type"], additionalProperties: true } } },
    ...
    { type: "function", function: { name: "tripo_getStsToken", description: "Get Tripo V3 upload credentials", parameters: { type: "object", properties: { format: { type: "string", enum: ["webp", "jpeg", "png"] } }, required: ["format"], additionalProperties: false } } },
